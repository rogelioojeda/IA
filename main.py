...
datos1 = pd.read_csv('C:/Users/Rogelio Ojeda/Desktop/Python Visual Code/barcodes2.csv', index_col=0)
datos1.to_csv('C:/Users/Rogelio Ojeda/Desktop/Python Visual Code/barcodes.csv')
print(datos1.head())
